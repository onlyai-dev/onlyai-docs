---
title: Welcome & Warmup Content
description: How to set up media for the welcome message and warmup drip sequence.
sidebar:
  order: 3
---
## Welcome content
...
When a fan subscribes and the **Welcome Flow** is enabled, the AI sends a welcome message. If a welcome content folder is configured, it can attach media from that folder to the greeting.
...
The **Warmup** group holds media used in the **warmup drip sequence** — a series of messages sent to fans who have gone quiet.

The AI uses warmup content to re-engage fans and nudge them toward buying PPV content or just maintaining the relationship.
...
→ See [Welcome Flow setup →](/welcome-flow/setup/)
