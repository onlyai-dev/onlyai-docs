...
3. Click **Connect**. OnlyAI will attempt to sign in to OnlyFans and initialize the connection.
...
3. Complete the face scan on the OnlyFans website.
4. Return to the OnlyAI wizard and click **Resume** to continue the connection.
