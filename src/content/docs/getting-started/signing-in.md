---
title: Signing In
description: How to sign in to OnlyAI and what to expect during first-time onboarding.
sidebar:
  order: 2
---
...
If this is your first time signing in and you haven't been added to an agency yet, you'll land on the **onboarding waiting room** instead of the dashboard.

This is normal. Access to the dashboard requires an administrator to assign you to an agency first.
...
:::tip
While you wait, you can leave the tab open in the background and come back to it — the auto-redirect will still fire.
:::

## Returning users

If you've already been assigned to an agency, signing in will take you straight to the dashboard. No waiting room needed.
