import { ay as generateCspDigest, Z as spreadAttributes, aW as unescapeHTML, T as renderTemplate, aX as removeBase, aY as isRemotePath, A as AstroError, aZ as UnknownContentCollectionError, aV as AstroUserError, a8 as defineMiddleware, ah as sequence } from './chunks/sequence_CJgvAEDL.mjs';
import 'piccolore';
import 'clsx';
import 'html-escaper';
import { Traverse } from 'neotraverse/modern';
import * as z from 'zod/v4';
import { c as createComponent } from './chunks/astro-component_Bpm7Fjnt.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./chunks/_astro_data-layer-content_BKQZ5wVW.mjs');
...
const starlightConfig = {"defaultLocale":{"label":"English","lang":"en","dir":"ltr","locale":"root"},"locales":{"root":{"label":"English","lang":"en","dir":"ltr"},"ru":{"label":"Русский","lang":"ru","dir":"ltr"},"uk":{"label":"Українська","lang":"uk","dir":"ltr"}}};

const project = {"root":"file:///Users/dankorotenko/Documents/projects/onlyai-docs/","srcDir":"file:///Users/dankorotenko/Documents/projects/onlyai-docs/src/"};
